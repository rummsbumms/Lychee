...
final class German
{
	...
	static public function get_locale()
	{
		$locale = array(
			...
			'DELETE_ALBUM_CONFIRMATION_2'	=> 'und alle darin enthaltenen Fotos löschen wollen? Diese Aktion kann nicht rückgängig gemacht werden!',
			...
			'DELETE_ALBUMS_CONFIRMATION_2'	=> 'ausgewählten Alben und die darin enthaltenen Fotos löschen wollen? Diese Aktion kann nicht rückgängig gemacht werden!',
			...
			'ALBUM_MERGE_2'				=> 'zusammenführen wollen in das Album',
			'ALBUMS_MERGE'				=> 'Sind Sie sicher, dass Sie alle ausgewählten Alben zusammenführen möchten in das Album',
			...
			'LOADING'					=> 'Laden',
			'ERROR'						=> 'Fehler',
			'ERROR_TEXT'				=> 'Ups, da ist etwas schiefgegangen. Bitte laden Sie die Seite erneut und probieren Sie es noch einmal!',
			...
			'ERROR_LOGIN'				=> 'Zugangsdaten können nicht gespeichert werden. Bitte probieren Sie es mit einem anderen Benutzernamen und Kennwort erneut!',
			'SUCCESS'					=> 'OK',
			...
			'PASSWORD_TEXT'				=> 'Ihr Benutzername und Kennwort werden wie folgt geändert:',
			...
			'DROPBOX_TEXT'				=> "Um Ihre Fotos von Dropbox zu importieren, brauchen Sie einen gültigen App-Key von <a href='https://www.dropbox.com/developers/apps/create'>der Dropbox Webseite</a>. Erstellen Sie einen persönlichen Schlüssel und geben Sie ihn unten ein:",
			...
			'UPLOAD_ERROR_CONSOLE'		=> 'Bitte schauen Sie in die Konsole ihres Browsers, um weitere Details zu erfahren.',
			'UPLOAD_UNKNOWN'			=> 'Der Server hat eine unbekannte Antwort gegeben. Bitte schauen Sie in die Konsole ihres Browsers, um weitere Details zu erfahren.',
			...
			'UPLOAD_IMPORT_SERVER_INSTR'=> 'Diese Aktion wird alle Fotos, Ordner und Unterordner importieren, die sich in folgendem Verzeichnis befinden. Die <b>Originaldateien werden nach dem Import gelöscht </b>, falls möglich.',
